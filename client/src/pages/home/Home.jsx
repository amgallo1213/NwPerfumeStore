        ...
        <>
            ...
            <div className='container mx-auto h-screen  max-w-5xl grid grid-cols-4 grid-rows-3' >
                ...
                <figure className='col-start-1 col-end-3 row-start-1 row-end-2 relative text-center overflow-hidden'>
                    <img src="https://images.pexels.com/photos/4554007/pexels-photo-4554007.jpeg?auto=compress&cs=tinysrgb&w=800&lazt=load" alt="" id="img-home" />
                ...
                <img src="https://images.pexels.com/photos/12146871/pexels-photo-12146871.jpeg?auto=compress&cs=tinysrgb&w=800&lazy=load" alt="" className=' col-start-3 col-end-4 row-start-1 row-end-2' id="img-home" />

                <figure className='row-start-1 row-end-3 relative text-center '>
                    <img src="https://images.pexels.com/photos/4154205/pexels-photo-4154205.jpeg?auto=compress&cs=tinysrgb&w=800" alt="" id="img-home" />
                    <figcaption className='z-50 absolute inset-x-0 bottom-0'>
                ...
                <img src="https://images.pexels.com/photos/8625543/pexels-photo-8625543.jpeg?auto=compress&cs=tinysrgb&w=800&lazy=load" alt=""  id="img-home"/>

                <div className='text-center font-secondary' >
                    <Link><p className='text-darkblue'>Closeness begins here</p></Link>
                </div>

                <img src="https://images.pexels.com/photos/8625562/pexels-photo-8625562.jpeg?auto=compress&cs=tinysrgb&w=800&lazy=load" alt=""  id="img-home"/>

                <figure className='row-span-2 relative text-center'>
                    <img src="https://images.pexels.com/photos/4154204/pexels-photo-4154204.jpeg?auto=compress&cs=tinysrgb&w=800&lazy=load" alt="" id="img-home" />
                    <figcaption className='z-50 absolute inset-x-0 bottom-0'>
                ...
                <img src="https://images.pexels.com/photos/12402366/pexels-photo-12402366.jpeg?auto=compress&cs=tinysrgb&w=800&lazy=load" alt="" className='row-span-2 col-start-2 col-end-4' id="img-home" />

                <img src="https://images.pexels.com/photos/4938265/pexels-photo-4938265.jpeg?auto=compress&cs=tinysrgb&w=800&lazy=load" alt="" className='row-span-2'  id="img-home" />
            </div>
